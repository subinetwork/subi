...
from test_framework.test_framework import SubiTestFramework
...
class LLMQChainLocksTest(SubiTestFramework):
    def set_test_params(self):
        self.set_subi_test_params(6, 5, fast_dip3_enforcement=True)
