...
"""Verify that starting subid with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start subid with -h for help text")
        ...
        self.log.info("Start subid with -version for version information")
