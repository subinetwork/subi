...
This mechanism has been integrated into Bitcore-Node-Subi which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/subinetwork/insight-api-subi#web-socket-api](https://github.com/subinetwork/insight-api-subi#web-socket-api)
* API: [https://github.com/subinetwork/insight-api-subi#instantsend-transactions](https://github.com/subinetwork/insight-api-subi#instantsend-transactions)
