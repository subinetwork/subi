...
This document provides guidelines for internationalization of the Subi Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `subi_en.ts` remains unchanged.
