...
* subi.conf: contains configuration settings for subid or subi-qt
* subid.pid: stores the process id of subid while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by subid or subi-qt
