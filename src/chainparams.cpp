...
{
    const char* pszTimestamp = "SUBI Network Protocol unreality worl crypto cryptocurrencies 01/10/2022";
...
//        }
        ...
        consensus.nFounderPayment = FounderPayment(rewardStructures, 750);
        ...
        vSporkAddresses = {"SQMnuCw4y2NNVWGvfm8irAV2hpebzANFLQ"};
        nMinSporkKeys = 1;
        ...
        chainTxData = ChainTxData{
            1684675316,   // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams() {
        ...
        consensus.nFounderPayment = FounderPayment(rewardStructures, 200, "SQMnuCw4y2NNVWGvfm8irAV2hpebzANFLQ");
