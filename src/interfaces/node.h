...
//! Interface for the src/evo part of a subi node (subid process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a subi node (subid process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a subi node (subid process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a subi node (subid process).
class Node
{
public:
    virtual ~Node() {}
