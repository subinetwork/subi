...
#error Client version information missing: version is not defined by subi-config.h or in any other way
#endif
...
/**
 * subid-res.rc includes this file, but it cannot cope with real c++ code.
