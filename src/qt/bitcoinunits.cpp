...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(SUBI);
    unitlist.append(mSUBI);
    unitlist.append(uSUBI);
...
QString BitcoinUnits::name(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            ...
            case mSUBI: return QString("mSUBI");
            case uSUBI: return QString::fromUtf8("μSUBI");
    ...
    else
    {
        switch(unit)
        {
            case SUBI: return QString("tSUBI");
            case mSUBI: return QString("mtSUBI");
            case uSUBI: return QString::fromUtf8("μtSUBI");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case SUBI:  return 100000000;
    case mSUBI: return 100000;
    case uSUBI: return 100;
    case ruffs: return 1;
