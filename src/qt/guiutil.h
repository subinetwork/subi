...
namespace GUIUtil
{
    ...
    // Parse "subi:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load subi specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a subi specific theme is activated (light/dark).*/
