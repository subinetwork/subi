Contributing to subi Core
============================

The subi Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/subinetwork/subi/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the subi Core project (and related
projects such as libsecp256k1), and is not to be confused with overall subi
Network Protocol consensus changes.

Whether a pull request is merged into subi Core rests with the project merge
...
Patches that change subi consensus rules are considerably more involved than
...
Where a patch set proposes to change the subi consensus, it must have been
...
The review process is normally fairly responsive on the subi Core repository, however
...
The project leader is the release manager for each subi Core release.
