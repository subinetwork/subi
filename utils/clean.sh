...
rm -rf test_bitcoin.coverage/ subi-gtest.coverage/ total.coverage/
...
clean_exe src/subi-cli
clean_exe src/subid
clean_exe src/subi-gtest
clean_exe src/subi-tx
clean_exe src/test/test_subi
clean_exe src/test/test_subi_fuzzy
...
clean_dep . src/config/subi-config.h.in
